                        ...
                        <div id="notifyLeavesDiv" style="height: 400px; overflow-y: scroll;">
                            ...
                            <%
                                ...
                                for (int i = 0; i < objArr.length(); i++) {
                                    ...
                                    String princStatus = objArr.getJSONObject(i).getString("prncStatus");
                                    String str = princStatus;
                                    if(princStatus == "approved" || princStatus.equals("approved")){
                                        princStatus = "";
                                    }else{
                                        princStatus = "disabled";
                                    }
                            %>
    ...
    <% } %>                    
        <script>
            ...
            function acceptOrIgnore(yesNoFlag,msg,user,objId,divId,uleaves,uleaveBal,ucount,casOrDuty,otherStatus,utype){
                ...
                if(casOrDuty == "casual" && status == "approved"){
                    uleaveBal -= ucount;
                    uleaves -= ucount;
                }
